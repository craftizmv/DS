...
func TestKnapsack2(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// got := Knapsack(tt.weights, tt.values, tt.capacity)
			got := Knapsack2(tt.weights, tt.values, tt.capacity)
			if got != tt.want {
				t.Errorf("Knapsack() = %v, want %v", got, tt.want)
			}
		})
...
// testing knapsack algo with forward weight addition
func TestKnapsackWA(t *testing.T) {
	tests := []struct {
		name     string
		weights  []int
		values   []int
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := KnapsackWA(tt.weights, tt.values, tt.capacity)
			if got != tt.want {
				t.Errorf("Knapsack() = %v, want %v", got, tt.want)
			}
		})
